 ...
 * private Player player;
 * 
 * public PlayerKeyboardInputController(Player player) { this.player = player; }
 * 
 ...
 * 
 * if (e.getKeyCode() == KeyEvent.VK_SPACE) player.shoot();
 * 
 * if(e.getKeyCode() == KeyEvent.VK_ESCAPE) player.pauseGame();
 * 
 * 
 * if (e.getKeyCode() == KeyEvent.VK_LEFT || e.getKeyCode() == KeyEvent.VK_A)
 * player.moveLeft(); if (e.getKeyCode() == KeyEvent.VK_RIGHT || e.getKeyCode()
